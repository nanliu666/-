<template>
  <div class="numInterval">
    <el-form ref="form" :model="value" :rules="rules" :inline="true" class="numInterval-form">
      <el-form-item prop="min">
        <el-input v-model="value.min" :placeholder="minPlaceholder" @input="handleMinChange" />
      </el-form-item>
      <span>至</span>
      <el-form-item prop="max">
        <el-input v-model="value.max" :placeholder="maxPlaceholder" @input="handleMaxChange" />
      </el-form-item>
    </el-form>
  </div>
</template>
