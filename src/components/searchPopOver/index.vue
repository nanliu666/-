<template>
  <div>
    <el-form :inline="true" class="require-form" @submit.native.prevent>
      <el-form-item
      ...
      >
        ...
        >
          ...
          <div v-show="item.noMore" style="text-align: center; font-size: 14px; color: #606266">
            没有更多了
          </div>
        </el-select>
        <el-time-select
        ...
        <el-time-picker
          ...
          @change="change"
        />
        <el-cascader v-if="item.type === 'cascader'" v-model="item.data" :options="item.options" />
        <el-date-picker
          ...
          @change="change"
        />
        <num-interval v-if="item.type === 'numInterval'" v-model="item.data" />
        <el-tree-select
      ...
      <el-form-item v-if="popoverOptions.length > 0" class="require-form-item">
        <el-popover
          v-model="popoverShow"
          placement="bottom"
          trigger="click"
        ...
        >
          <div>
            <el-form size="small" class="popover-form" label-position="top">
              <el-row justify="start" :gutter="24">
                <el-col v-for="item in popoverOptions" :key="item.field" :span="8">
            ...
            <div class="popOver-footer">
              <el-button type="primary" size="medium" @click="submitSearch">
                搜索
              </el-button>
