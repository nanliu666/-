    ...
    <div class="body">
      <div class="left-area">
        ...
        <el-tabs v-model="activeTab" class="tab">
          <el-tab-pane label="组织机构" name="tree">
            <el-input
              v-model="search"
              class="search"
              ...
              clearable
            ></el-input>
            <el-scrollbar v-loading="treeLoading" class="scroll-bar" native>
              <el-tree
                ref="tree"
                lazy
                show-checkbox
          ...
          <el-tab-pane label="外部人员" name="checkbox">
            <el-input
              ...
              placeholder="搜索成员姓名"
            ></el-input>
            <el-scrollbar v-loading="checkboxLoading" class="scroll-bar check-list" native>
              <div v-if="outerData.length" class="checkbox-wrapper">
                <el-checkbox
                  v-model="checkAll"
                ...
                <el-checkbox-group v-model="checkedOuter" @change="outerCheckChange">
                  <el-checkbox
      ...
      <div class="right-area">
        <div class="area-header">已选：{{ selectList.length }}人</div>
        <div class="select-wrapper">
          <el-scrollbar v-if="selectList.length" class="scroll-bar" style="height: 100%" native>
