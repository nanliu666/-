    ...
    <div class="content">
      ...
      <el-row>
        <el-col :span="8" class="experienceList"
          ...
          ><span class="wContent">{{ applyDetail.userName }}</span></el-col
        >
        <el-col :span="8" class="experienceList"
          ><span class="name">性别：</span
          ><span class="wContent">{{ applyDetail.sex }}</span></el-col
        >
        <el-col :span="8" class="experienceList"
          ><span class="name">出生年月：</span
          ><span class="wContent">{{ applyDetail.birthDate }}</span></el-col
        >
        <el-col :span="8" class="experienceList"
          ><span class="name">所属部门：</span
          ><span class="wContent">{{ applyDetail.orgName }}</span></el-col
        >
        <el-col :span="8" class="experienceList"
          ><span class="name">工作岗位：</span
          ><span class="wContent">{{ applyDetail.position }}</span></el-col
        >
        <el-col :span="8" class="experienceList"
          ><span class="name">职业资格/职称：</span
          ><span class="wContent">{{ applyDetail.jobName }}</span></el-col
        >
      </el-row>
    </div>
    <div class="content">
      ...
      <el-row>
        ...
        <el-col :span="8" class="experienceList">
          ...
          <span class="wContent"
            >{{ dateConver(formDetaill.trainStartTime) }} 至
            {{ dateConver(formDetaill.trainEndTime) }}</span
          >
        </el-col>
        <el-col :span="8" class="experienceList">
...
<script>
import { trainingOuterDetails } from '@/api/apply'
