...
<template>
  <div class="applyCourseDevDet">
    ...
    <div class="content">
      ...
      <el-row>
        <el-col :span="8" class="experienceList">
          ...
          <span class="wContent">{{ dateConver(formDetaill.workStartTime) }}</span>
        </el-col>
        <el-col :span="8" class="experienceList">
          <span class="name">徐工工作日期：</span>
          <span class="wContent">{{ dateConver(formDetaill.xgWorkStartTime) }}</span>
        </el-col>
        <el-col :span="8" class="experienceList">
    ...
    <div class="content">
      ...
      <el-row>
        <el-col :span="6" class="experienceList">
        ...
        <el-col :span="24" class="experienceList">
          <span class="name">专业学习：</span>
          <span class="wContent">{{ formDetaill.professionalLearning }}</span>
        </el-col>
      </el-row>
      <h4>参与课程开发</h4>
...
<script>
import { teacherAuthApplyDetail } from '@/api/apply'
