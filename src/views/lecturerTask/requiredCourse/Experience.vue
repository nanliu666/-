<template>
  <div v-if="tableData" class="courseTask">
    <el-table
      v-loading="isLoading"
      :data="tableData"
      style="width: 100%"
...
import { experience } from '@/api/lecturerTask'
...
export default {
  ...
  methods: {
    ...
    async getInfo() {
      let params = { studyPlanId: this.$route.query.studyPlanId, userId: this.$route.query.stuId }
      let res = await experience(params)
      this.tableData = res
    },
    // 打包下载
    handleUpload() {
