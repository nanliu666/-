<template>
  <div class="CertificateComponents">
    <div class="Certificate">
      <!-- {{CertificateData}} -->
      <img class="bg" :src="CertificateData.backUrl" /><img />
      <div class="logo"><img class="log_img" :src="CertificateData.logoUrl" /> <img /></div>
      <div class="certificateNo">编号：{{ CertificateData.certificateNo }}</div>

      <div class="title">{{ CertificateData.templateName }}</div>
      <div class="name_text">
        <span class="_name">{{ CertificateData.stuName }}<span>同志： </span> </span>
        <pre>{{ CertificateData.text }} </pre>
      </div>

      <div class="awardAgency">
        <div class="name">{{ CertificateData.awardAgency }}</div>
        <div class="grantTime">{{ itmeHandle(CertificateData.grantTime) }}</div>
      </div>
    </div>
  </div>
</template>
